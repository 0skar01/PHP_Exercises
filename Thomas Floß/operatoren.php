...
echo decbin($a) . "<br>";           
echo decbin($a << 3) . "<br>";      // Linksschieben um 3 Stellen

// Vergleichsoperatoren

echo "Vergleichsoperatoren<br>";
$d = true;                  // true sind auch alle Zahlen (int, float) ungleich 0
$e = false;                 // false ist auch 0
$f = 1;

echo "gleich: ". ($d == $f) . "<br>";           // gleich - es werden nur die Werte überprüft
echo "identisch: " . ($d === $f) . "<br>";      // identisch - es werden die Werte und der Datentyp überprüft

echo "ungleich: ". ($d != $f) . "<br>";           // ungleich - es werden nur die Werte überprüft
echo "ungleich: ". ($d <> $f) . "<br>";           // ungleich - es werden nur die Werte überprüft
echo "unidentisch: " . ($d !== $f) . "<br>";      // unidentisch - es werden die Werte und der Datentyp überprüft
